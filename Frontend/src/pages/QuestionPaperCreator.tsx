        ...
        <div className="grid grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-6 max-h-[calc(100vh-160px)] overflow-y-auto pr-2">
            <div className="space-y-4 pb-6">
              ...
              <div className="glass-card p-6 rounded-2xl border border-blue-100/50 shadow-xl hover:shadow-2xl transition-all">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl glass-button flex items-center justify-center shadow-lg bg-gradient-to-br from-green-500 to-emerald-600">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-500/60 font-medium">
                      Paste link to skip manual form filling
                    </p>
                  </div>
                </div>
                <input
                ...
                />
                {googleFormLink && (
                  <div className="mt-3 p-3 rounded-lg bg-green-50/40 border border-green-200/60">
                    <p className="text-xs text-green-700 font-semibold flex items-center gap-2">
                      <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                      Form link added! Manual form filling is optional.
                    </p>
                  </div>
                )}
              </div>

              {/* OR Divider - only show when there's no link */}
              {!googleFormLink && (
                <div className="flex items-center gap-4 my-6">
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-blue-300 to-transparent"></div>
                  <span className="text-sm font-bold text-blue-600 glass-card px-4 py-2 rounded-full shadow-md">
                    OR Create Manually
                  </span>
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-blue-300 to-transparent"></div>
                </div>
